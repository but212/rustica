...
mod tests {
    use super::Either;
    use crate::datatypes::error::EitherError;
    use crate::traits::{applicative::Applicative, functor::Functor, monad::Monad};
    ...
    fn test_either_utilities_and_conversions() {
        ...
        assert_eq!(left.clone().right_or("default".to_string()), "default");
        assert_eq!(right.clone().right_or("default".to_string()), "ok");
