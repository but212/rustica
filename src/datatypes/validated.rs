...
impl<E, A> Validated<E, A> {
        ...
        E: std::fmt::Debug,
    {
        match self {
            Validated::Valid(a) => a,
            Validated::Invalid(e) => panic!("Called Validated::unwrap_owned() on an Invalid value: {e:?}"),
        }
    }
    ...
    {
        match self {
            Validated::Valid(a) => panic!("Called Validated::unwrap_invalid_owned() on a Valid value: {a:?}"),
