    ...
    A: ReturnTypeConstraints,
{
    ...
    pub run_cont: FnType<FnType<A, R>, R>,
}
    ...
    A: ReturnTypeConstraints,
{
        ...
        F: FnTrait<FnType<A, R>, R>,
    {
        let f = Arc::new(f);
        Cont {
            run_cont: FnType::new(move |k| f.call(k)),
        }
    }
    ...
    A: ReturnTypeConstraints,
{
    ...
    fn pure(value: A) -> Self::Output<A> {
        ...
        Cont {
            run_cont: FnType::new(move |k: FnType<A, R>| k.call((*value).clone())),
        }
    }
}
    ...
    A: ReturnTypeConstraints,
{
        ...
        F: FnTrait<A, B>,
    {
        let f = Arc::new(f);
        Cont {
            run_cont: FnType::new(move |k: FnType<B, R>| {
                let f = Arc::clone(&f);
    ...
    A: ReturnTypeConstraints,
{
        ...
        F: FnTrait<A, FnType<B, C>>,
    {
        ...
        let b = Arc::new(b);
        Cont {
            run_cont: FnType::new(move |k: FnType<C, R>| {
                let k = Arc::new(k);
                let f = Arc::clone(&f);
                let b = Arc::clone(&b);
                let this = Arc::clone(&this);
        ...
        F: FnTrait<A, FnType<B, FnType<C, D>>>,
    {
        ...
        let c = Arc::new(c);
        Cont {
            run_cont: FnType::new(move |k: FnType<D, R>| {
                let k = Arc::new(k);
                let f = Arc::clone(&f);
                let b = Arc::clone(&b);
                let c = Arc::clone(&c);
